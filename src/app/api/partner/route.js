...
export async function POST(req) {
	try {
		const { fullName, businessEmail, companyName, phoneNumber, partnershipType, proposalDetails } = await req.json();

		if (!fullName || !businessEmail || !companyName || !partnershipType || !proposalDetails) {
						...
						<div style="font-family: Arial, sans-serif; padding: 20px;">
							...
							<table style="border-collapse: collapse; width: 100%; max-width: 600px;">
								...
								<tr>
									...
									<td style="padding: 10px; border: 1px solid #ddd;">${partnershipType}</td>
								</tr>
								<tr>
									<td style="padding: 10px; border: 1px solid #ddd; font-weight: bold;">Proposal Details</td>
									<td style="padding: 10px; border: 1px solid #ddd; white-space: pre-wrap;">${proposalDetails}</td>
								</tr>
							</table>
						</div>
					`
		...
		const autoReplyPayload = {
			message: {
				subject: "Your Partnership Inquiry - Ziqora Energy",
				body: {
					contentType: "HTML",
					content: `
						<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; background-color: #ffffff; color: #333333; border: 1px solid #eaeaea; border-radius: 8px;">
							...
							<h2 style="color: #0c1930; font-size: 24px; margin-bottom: 20px; font-weight: 600;">Partnership Proposal Received</h2>
							
							<p style="line-height: 1.6; font-size: 16px; margin-bottom: 15px;">Dear ${fullName},</p>
							
							<p style="line-height: 1.6; font-size: 16px; margin-bottom: 15px;">Thank you for reaching out to explore partnership opportunities with Ziqora Energy. We have successfully received your proposal regarding <strong>${partnershipType}</strong>.</p>
							
							<p style="line-height: 1.6; font-size: 16px; margin-bottom: 30px;">Our strategic partnership team will carefully review the details you provided and will get back to you shortly to discuss potential next steps.</p>
							
							<div style="margin-top: 30px; padding-top: 25px; border-top: 2px solid #f4f4f4;">
								<p style="margin: 0 0 5px 0; font-weight: 600; font-size: 16px; color: #0c1930;">Strategic Partnerships Team</p>
								<p style="margin: 0 0 5px 0; font-size: 14px; color: #666666;">Ziqora Energy</p>
