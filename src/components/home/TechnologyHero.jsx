                ...
                <div className="row align-items-center">
                    <div className="col-lg-9 text-start">
                        ...
                        >
                            ...
                            <span style={{ color: "#10b981", fontWeight: "300" }}>& Solar Innovations</span>
                        </h1>
                        <p
                            className="wow fadeInUp"
                            data-wow-delay=".5s"
                        ...
                        >
                            Establishing a world-class manufacturing infrastructure, detailing our operational frameworks for monocrystalline silicon ingot casting, precision wire slicing, and automated cell processing.
                        </p>
