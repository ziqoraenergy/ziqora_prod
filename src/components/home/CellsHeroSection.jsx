		...
		>
			...
			<div 
				...
				style={{
					...
					width: "100%",
					height: "100%",
					backgroundImage: "url('/images/home/realistic_solar_cell_macro.png')",
			...
			<div className="container" style={{ position: "relative", zIndex: 2 }}>
				<div className="row align-items-center">
					<div className="col-lg-8 text-start">
						...
						>
							Engineering state-of-the-art photovoltaic cell processing lines to supply high-efficiency N-type TOPCon and HJT modules.
						</p>
						<div className="wow fadeInUp" data-wow-delay=".6s" style={{ color: "rgba(255, 255, 255, 0.6)", fontSize: "14px" }}>
							...
							<span style={{ margin: "0 10px" }}>/</span>
							<span>Solar Cell Technologies</span>
						</div>
					</div>
				</div>
			</div>
...
export default CellsHeroSection;
