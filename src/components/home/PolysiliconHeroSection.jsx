		...
		>
			...
			<div
				style={{
					...
					width: "100%",
					height: "100%",
					background: "linear-gradient(to right, rgba(10, 25, 49, 0.9) 0%, rgba(10, 25, 49, 0.6) 50%, rgba(10, 25, 49, 0.2) 100%)",
					zIndex: 1,
				}}
			></div>
			...
			<div className="container" style={{ position: "relative", zIndex: 2 }}>
				<div className="row align-items-center">
					<div className="col-lg-10 text-start">
						...
						>
							Technology & <span style={{ color: "#10b981" }}>Polysilicon Innovations</span>
						</h1>
						<p
							className="wow fadeInUp"
							data-wow-delay=".4s"
						...
						>
							Exploring advanced metallurgical purification, chemical vapor deposition (CVD), and ultra-high-purity silicon manufacturing frameworks.
						</p>
...
export default PolysiliconHeroSection;
