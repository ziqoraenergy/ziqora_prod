...
const manufacturingSteps = [
	{
		...
		specs: [
			...
			{ label: "Carbon Conc", value: "< 5.0├ù10┬╣Γü╡/cm┬│" }
		],
	...
	},
	{
		...
		specs: [
			{ label: "Wire Diameter", value: "35 ╬╝m - 47 ╬╝m" },
			{ label: "Thickness", value: "< 130 ╬╝m" },
			{ label: "Kerf Loss", value: "< 12 ╬╝m" },
			{ label: "Web Speed", value: "24 - 30 m/s" },
			{ label: "Thickness Var.", value: "< 3 ╬╝m" },
	...
	},
	{
		...
		specs: [
			...
			{ label: "Junction Depth", value: "0.3 - 0.5 ╬╝m" },
			{ label: "Passivation", value: "AlΓééOΓéâ / SiNx" },
			{ label: "Finger Width", value: "15 - 18 ╬╝m" },
													...
													>
														...
														{activeStep === 1 && (
															<svg viewBox="0 0 500 400" width="100%" height="100%" style={{ background: "transparent" }}>
																...
																<text x="395" y="283" fill="#10b981" fontSize="11" fontFamily="monospace">THIN WAFER (&lt;130╬╝m)</text>
																...
																<text x="55" y="283" fill="#10b981" fontSize="11" fontFamily="monospace" textAnchor="end">KERF LOSS (&lt;12╬╝m)</text>
